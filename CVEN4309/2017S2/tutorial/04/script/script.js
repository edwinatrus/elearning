var selection = [
    ["j<sub>2</sub>", "j2", "the duration of load factor for serviceability calculation"],
    ["j<sub>3</sub>", "j3", "the duration of load factor for serviceability tension calculations"],
    ["k<sub>12</sub>", "k12", "the buckling factor"],
    ["&rho;<sub>c</sub>", "rhoc", "the material constant for compression"],
    ["g<sub>13</sub>", "g13", "the effective length factor"]
];
