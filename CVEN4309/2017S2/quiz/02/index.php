...
<html lang="en">
    ...
    <body>
        <div style="max-width: 900px; border: 2px red solid; padding: 1em; margin: 2em auto;">
            <p>
                <strong>IMPORTANT NOTICE:</strong><br/><br/>You can have <strong>ONLY ONE</strong> chance to attempt the quiz. By Clicking the button below, you start you attempt. Please ensure your network condition is good and stable since you do not have a second chance to attempt the quiz unless special permission is granted by the instructor.
            </p>
            <p>
                A timer is set and shown in the upper right during the quiz. When the time is up, your result will be submitted regardless of whether you finished or not!
            </p>
            <p>
